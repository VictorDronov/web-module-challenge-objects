...
// }
// console.log(createMenuItem('Sub', 5, 'Lunch'))
// console.log(createMenuItem('MeatPizza', 7, 'Lunch'))
// console.log(createMenuItem('Cheesecake', 4, 'Dessert'))

// /* Task 1b: use your function to create 3 more menu items. You may add any items to the menu that you'd like */
// console.log(createMenuItem('Cheesecake', 4, 'Dessert'))
// console.log(createMenuItem('Chocolate Chip Cookies', 2, 'Dessert'))
// console.log(createMenuItem('PieCherry', 4, 'Dessert'))
...
console.log(addreview(reviews,'Victor','5','Lovely Food'))

/* Task 5: Add the following feedback to Reyna's rating - "this place is chill with really cool people, great for getting work done on weekdays"*/
function replaceReview (arr,index,feedback){
  arr[index].feedback = feedback; {
    return arr;
  }
}
console.log(replaceReview(reviews,7,"this place is chill with really cool people, great for getting work done on weekdays"))
